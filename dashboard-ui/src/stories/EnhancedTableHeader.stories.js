...
export const Default = () => <EnhancedTableHeader { ...defaultData } />;

export const AscendingSortedCell = () => <EnhancedTableHeader { ...sortedAscData } />;

export const DescendingSortedCell = () => <EnhancedTableHeader { ...sortedDescData } />;